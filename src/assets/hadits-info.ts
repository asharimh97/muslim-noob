...
export const haditsInfo: HaditsInfoItem[] = [
	{
		id: 1,
	...
	},
	{
		...
		aboutWriter:
			'Al-Albani was an Albanian Islamic scholar, reformer and revivalist. Among the most prominent figures of Salafism, Al-Albani is widely regarded as one of the most significant Islamic scholars of the 20th century, and is frequently ranked as the greatest hadith scholar of all time.',
